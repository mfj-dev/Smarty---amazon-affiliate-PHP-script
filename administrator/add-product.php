...
include 'PHP/add-product-code.php';
$current1 = '';
$current2 = '';
$current3 = '';
$current4='current';
        ...
        <div id="sample">
            <div class="content-empty">
                ...
                <form action="" method="POST">
                    <input type="text" placeholder="Product name" name="product_name" class="form-control" data-toggle="tooltip" data-placement="right" title="Add product name here! (Avoid long names of a product)" required />
                    <select class="form-control" name="product_category">
             <option value="" disabled selected>
               Add category
            </option>
            <?php
            foreach ($connread->query($category_query) as $row) {
            ...
            <?php } ?>
                    ...
                    <br>
                    <input type="text" class="form-control" placeholder="Product SEO friendly URL" class="left" name="product_url" data-toggle="tooltip" data-placement="right" 
					title="Add URL of a page here! Avoid hypens and put your keywords here! (ex:
                keyword1-keyword2)" required/>
               <input type="text"  placeholder="Product Amazon.com URL"  name="product_amazon_url" class="form-control" placeholder="Product SEO friendly URL"  data-toggle="tooltip" data-placement="right" 
					title="Add Amazon.com link of the product here!)" required/>
			   <input type="text"  placeholder="Product Title tag"  name="product_title_tag" class="form-control" placeholder="Product SEO friendly URL"  data-toggle="tooltip" data-placement="right" 
			title="Add title tag of a page here! Write 40 - 70 characters! (ex: keyword1 - keyword2 |
                keyword3)" required/>
		    <select required  class="form-control" name="product_brands">
            <option value="" disabled selected>
              Add  Brand
            </option>
            <?php
            foreach ($connread->query($brands_query) as $row) {
                ...
                ?>
                <option value="<?php echo $product_brand_id; ?>">
                    <?php echo $product_brand; ?>
                </option>
            <?php } ?>
        </select>
		<br>
		 <label id="currency">&#36;</label><input class="form-control" style="padding-left:22px; border-radius:0px!important;" name="product_price" onkeypress="return isNumberKey(event)"
...
<input required  id="proicon" placeholder="Pro:"  class="form-control" name="product_pros" type="text"  data-toggle="tooltip" data-placement="right" 
			title="Add pros of the product here!"/>
<input required  id="conicon" placeholder="Con:"  class="form-control" name="product_cons" type="text"  data-toggle="tooltip" data-placement="right" 
			title="Add cons of the product here!"/>
<input required class="form-control" style="border-radius:0px!important;" name="product_avg_rating" placeholder="0.00" onkeypress="return isNumber1(event)" id="number"
      class="rating" type="number" min="0.00" max="5.00" step="0.01" />
	  			<script>
...
<h5><b>Product review</b></h5>
 ...
 Write your product description here...
                    ...
                    <button type="submit" name="register_product" class="btn btn-primary">Add new product</button>
                </form>
                <br>
            </div>
        </div>
