...
<div class="fifth-sixth-column">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="mailing-list.php" class="active">Mailing list</a></li>
    </ol>
    <!-- Breadcrumbs for admin panel ------ END -->
  <div class="content-empty">
 <a href="edit-mail.php" class="btn btn-primary">Generate email</a>
 <a href="mailing-list.php"  class="btn btn-success">Go to mailing list</a>
 <div class="clearfix"></div>
	...
	<div id="mail-wrapper">
<?php
    foreach ($connread->query($admin_mail_query) as $row) {
    $admin_mail_title=$row['admin_mail_title'];
	$admin_mail_image=$row['admin_mail_image'];
	$admin_mail_text=$row['admin_mail_text'];
	?>
<?php echo $admin_mail_text;?>
<?php } ?>
</div>
</div>
</div>
