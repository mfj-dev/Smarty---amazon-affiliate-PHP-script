...
include 'PHP/add-blog-image-code.php';
$current1 = '';
$current2 = '';
$current3 = '';
$current4='';
...
<div class="fifth-sixth-column">
    ...
    <div class="content">
        <div id="sample">
			...
			?>
			<img src="../img/<?php echo $blog_image; ?>" class="img-thumbnail medium-img" />
			<br><br>
				<?php } ?>
			<?php } ?>
                 <form method="post" enctype="multipart/form-data" action="">
                <input required type="file" accept='image/x-png, image/jpeg' name="userfile" />
                    <button type="submit" name="add_blog_image"  class="btn btn-primary">Add blog article image</button>
                </form>
                <br>
            </div>
        </div>
