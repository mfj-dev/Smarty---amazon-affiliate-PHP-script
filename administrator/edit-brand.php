...
include 'PHP/edit-brand-code.php';
$current1 = '';
$current2 = '';
$current3 = '';
$current4='';
...
<div class="fifth-sixth-column">
    ...
    <div class="content">
        ...
        foreach ($connread->query($this_brand_query) as $row) {
            ...
            $product_brand_h1 = $row['product_brand_h1'];
            $product_brand_meta_tag = $row['product_brand_meta_tag'];
            ?>
			
			<?php } ?>
			<input required value="<?php echo $product_brand; ?>" name="product_brand"  class="form-control" data-toggle="tooltip" data-placement="right" title="You can edit product brand name here." type="text"/>
			<input required value="<?php echo $product_brand_url; ?>" name="product_brand_url"   class="form-control" data-toggle="tooltip" data-placement="right" title="Change your URL here. (Try to make it SEO friendly)" type="text"/>
			<input required value="<?php echo $product_brand_title_tag; ?>" name="product_brand_title_tag"   class="form-control" data-toggle="tooltip" data-placement="right" title="You can change your product brand Title tag here. (make it SEO friendly, 40 - 70
                    characters) " type="text"/>
			<input required value="<?php echo $product_brand_h1; ?>" name="product_brand_h1"   class="form-control" data-toggle="tooltip" data-placement="right" title="You can change your product brand H1 title here. (this will display on the category
                    page)" type="text"/>
...
<?php echo $product_brand_meta_tag; ?>
</textarea>
<br>
</script>	
