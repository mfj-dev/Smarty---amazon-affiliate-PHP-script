...
<div class="fifth-sixth-column">
 ...
 <a href="admin-mail.php" class="btn btn-primary">View email</a>
 ...
 <div class="clearfix"></div>
	...
	<div id="sample">
	<div class="content-empty">
	<h1>Update your mail</h1>
<form action="" method="POST">


   <textarea name="admin_mail_text"  class="ckeditor" cols="80" id="editor1" rows="10" style="width: 480px;  padding-left:15px!important; height:180px;
     border-color: #66afe9; 
   ...
   <br>
<button type="submit" name="update_mail"  class="btn btn-primary">Send mail</button>
</form>	
