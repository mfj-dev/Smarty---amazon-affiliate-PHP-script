...
include 'PHP/add-category-code.php';
$current1 = '';
$current2 = '';
$current3 = '';
$current4='';
    ...
    <div class="content">
        <div id="sample">
            <div class="content-empty">
                ...
                <input type="text" placeholder="Product category" name="product_category" class="form-control" data-toggle="tooltip" data-placement="right" title="Add new product category name here!" required />
               <input type="text"  placeholder="Category SEO friendly URL" name="product_category_url"  class="form-control"   data-toggle="tooltip" data-placement="right" title="Add URL of a page here! Avoid hypens and put your keyword here! (ex:
                keyword1-keyword2)" required/>
				<input type="text" placeholder="Category Title tag" name="product_category_title_tag" class="form-control" data-toggle="tooltip" data-placement="right" title="Add title tag of a page here! Write 40 - 70 characters! (ex: keyword1 - keyword2 |
                keyword3)" required />
				<input type="text" placeholder="Category H1 (Title)" name="product_category_h1" class="form-control" data-toggle="tooltip" data-placement="right" title="Add product category h1 (page title) here!" required />
...
Write meta tag here (maximum 155 characters)...
                    ...
                    <button type="submit" name="register_category" class="btn btn-primary">Add new product</button>
                </form>
                <br>
            </div>
        </div>
