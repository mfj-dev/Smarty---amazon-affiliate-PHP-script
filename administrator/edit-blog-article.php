...
include 'PHP/edit-blog-code.php';
$current1 = '';
$current2 = '';
$current3 = '';
$current4='';
...
<div class="fifth-sixth-column">
    ...
    <div class="content">
        <div id="sample">
            ...
            ?>
                    <input type="text" required value="<?php echo $blog_h1; ?>" name="blog_h1" class="form-control" data-toggle="tooltip" data-placement="right" title="Update your blog post H1 (title) here" required />
					<input type="text" required  value="<?php echo $blog_url; ?>" name="blog_url" class="form-control" data-toggle="tooltip" data-placement="right" title="Update URL of a page here! Avoid hypens and put your keyword here! (ex:
                keyword1-keyword2)" required />
                    <input type="text" class="form-control" value="<?php echo $blog_title_tag; ?>" name="blog_title_tag" data-toggle="tooltip" data-placement="right" title="Update title tag of a page here! Write 40 - 70 characters! (ex: keyword1 - keyword2 |
                keyword3)" required />
         <input type="text"   value="<?php echo $blog_author; ?>"  name="blog_author" class="form-control"   data-toggle="tooltip" data-placement="right" title="Update your fullname here! (ex: Jonh Smith)" required />
	     <input type="text"  value="<?php echo $blog_author_url; ?>"  name="blog_author_url" class="form-control"  data-toggle="tooltip" data-placement="right" title="Update your author URL here! (ex: your Google+ profile)" required/>
<h5><b>Blog article</b></h5>
        ...
        -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(102, 175, 233, .6);
         ...
         <?php echo $blog_article; ?>
                    ...
                    <button type="submit" name="update_blog_article"  class="btn btn-primary">Update blog article</button>
					<?php } ?>
                </form>
                <br>
            </div>
